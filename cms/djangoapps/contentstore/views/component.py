...
from xblock_django.models import XBlockStudioConfiguration
...
def _advanced_component_types(show_unsupported):
    ...
    """
    enabled_block_types = [c_type for c_type in ADVANCED_COMPONENT_TYPES if c_type not in disabled_xblocks()]
    ...
    if authorable_blocks is not None:
        ...
        for block_name in enabled_block_types:
            all_blocks[block_name] = XBlockStudioConfiguration.FULL_SUPPORT
        return all_blocks
